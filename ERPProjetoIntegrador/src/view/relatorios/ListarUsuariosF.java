...
public class ListarUsuariosF extends javax.swing.JInternalFrame {

    public ListarUsuariosF() {
        initComponents();
        this.setResizable(false);
        cbSituacao.removeAllItems();
        new ComboDAO().popularComboSituacao(cbSituacao);
    }
    ...
    private void initComponents() {
        ...
        setTitle("Listar usuários cadastrados:");
        setToolTipText("");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            List wEstados = wEstadoDAO.consultarRelatorio("inativo = '" + situacao + "'");
            JasperReport relatorio = JasperCompileManager.compileReport(getClass().getResourceAsStream("/relatorios/list_usuarios.jrxml"));
