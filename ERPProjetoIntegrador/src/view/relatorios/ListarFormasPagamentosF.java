...
public class ListarFormasPagamentosF extends javax.swing.JInternalFrame {

    public ListarFormasPagamentosF() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Listar formas de pagamentos cadastrados:");
        setToolTipText("");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            JasperReport relatorio = JasperCompileManager.compileReport(getClass().getResourceAsStream("/relatorios/list_formas_pagamentos.jrxml"));
