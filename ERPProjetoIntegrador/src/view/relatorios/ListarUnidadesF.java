...
public class ListarUnidadesF extends javax.swing.JInternalFrame {

    public ListarUnidadesF() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Listar unidades cadastrados:");
        setToolTipText("");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            JasperReport relatorio = JasperCompileManager.compileReport(getClass().getResourceAsStream("/relatorios/list_unidades.jrxml"));
